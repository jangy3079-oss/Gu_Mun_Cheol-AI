...
export async function POST(req) {
  try {
    ...
    const prompt = `
      ...
      [매우 중요한 지시사항: 본인과 상대방 구분법]
      - 본인(me): 카카오톡 화면의 **오른쪽**에 말풍선이 위치하며, 주로 **노란색** 말풍선을 사용합니다. 프로필 사진이 없습니다.
      - 상대방(other): 카카오톡 화면의 **왼쪽**에 말풍선이 위치하며, 주로 **흰색(또는 회색)** 말풍선을 사용합니다. 말풍선 옆에 프로필 사진이나 이름이 있습니다.
      절대로 본인과 상대방을 헷갈리지 마세요!
      ...
      추가 지시사항: 한문철 변호사 특유의 블랙박스 리뷰 말투(예: "이거 참 기가 막힙니다", "이게 말이 됩니까?", "블박차(본인) 잘못 하나도 없습니다" 등)를 사용하여 카톡 대화를 대화의 흐름(초반, 중반, 후반 등)에 따라 분석해 주세요. 
      특히 대화 중 문제가 되는 발언이나 상황을 블랙박스 영상 보듯이 콕 집어서 인용(quote)하고, 그에 대해 한문철 변호사님이 호통치거나 평가(eval)하는 내용을 담은 'analysis_bubbles' 배열을 작성하세요.
      ...
      모든 말풍선 분석이 끝난 후 최종 결론인 'analysis_conclusion'에는 반드시 과실 비율을 명확하게 외쳐야 합니다! 단, 임의로 숫자를 지어내지 말고, 아래의 정확한 텍스트 형태(중괄호 포함)를 그대로 사용하세요:
        ...
        "analysis_bubbles": [
          {
            ...
            "eval": "아니 이 사람 보세요! 상대방이 지금 새벽 2시에 다짜고짜 '자?' 하고 보내는데, 이거 명백한 수면 방해, 아니 야간 기습 톡이죠! 아주 위험한 운전입니다."
          },
          {
            "time_step": "대화 중반",
            "quote": "오전 09:30 본인 : ㅋ",
            "eval": "그런데 말입니다! 블박차(본인) 차주님은 아침 9시까지 푹 주무시다가 아주 침착하게 대답을 하셨어요. 그런데 ㅋㅋㅋ가 아니라 단답 'ㅋ'를 쏘네요? 이건 성의가 너무 없는 거 아닙니까!"
          }
        ],
